...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "catalog":
        ...
        category_id = int(data.replace("cat_", "", 1))
        ...
        model_id = int(data.replace("model_", "", 1))
        ...
        type_id = int(data.replace("type_", "", 1))
    ...
    # ===== ADMIN ADD =====
        ...
        page = int(data.replace("admin_add_model_page_", "", 1))
        ...
        category_id = int(data.replace("admin_model_cat_", "", 1))
        ...
        page = int(data.replace("admin_add_type_page_", "", 1))
        ...
        model_id = int(data.replace("admin_type_model_", "", 1))
        ...
        page = int(data.replace("admin_add_product_page_", "", 1))
        ...
        type_id = int(data.replace("admin_product_type_", "", 1))
    ...
    # ===== ADMIN EDIT CATEGORIES =====
        ...
        page = int(data.replace("admin_edit_categories_page_", "", 1))
        ...
        category_id = int(data.replace("admin_edit_category_", "", 1))
        category = get_category(category_id)
        ...
        category_id = int(data.replace("admin_rename_category_", "", 1))
        ...
        category_id = int(data.replace("admin_delete_category_", "", 1))
    ...
    # ===== ADMIN EDIT MODELS =====
        ...
        page = int(data.replace("admin_edit_models_page_", "", 1))
        ...
        model_id = int(data.replace("admin_edit_model_", "", 1))
        model = get_model(model_id)
        ...
        model_id = int(data.replace("admin_rename_model_", "", 1))
        ...
        model_id = int(data.replace("admin_model_desc_", "", 1))
        context.user_data["edit_model_id"] = model_id
        ...
        model_id = int(data.replace("admin_delete_model_", "", 1))
    ...
    # ===== ADMIN EDIT TYPES =====
        ...
        page = int(data.replace("admin_edit_types_page_", "", 1))
        ...
        type_id = int(data.replace("admin_edit_type_", "", 1))
        product_type = get_type(type_id)
        ...
        type_id = int(data.replace("admin_rename_type_", "", 1))
        ...
        type_id = int(data.replace("admin_type_desc_", "", 1))
        context.user_data["edit_type_id"] = type_id
        ...
        type_id = int(data.replace("admin_delete_type_", "", 1))
        delete_type(type_id)
